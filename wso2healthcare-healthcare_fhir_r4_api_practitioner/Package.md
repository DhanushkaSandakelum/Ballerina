...
| Documentation        | [https://www.hl7.org/fhir/Practitioner\.html](https://www.hl7.org/fhir/Practitioner\.html) |
...
1) Create an API project from this template
    ...
    ```bal new -t wso2healthcare/healthcare.fhir.r4.api.practitioner PractitionerAPI```
...
4) Invoke `<BASE_URL>/fhir/r4/Practitioner`
    1) Invoke from localhost : `http://localhost:9090/fhir/r4/Practitioner`
...
6) Invoke `<BASE_URL>/fhir/r4/Practitioner`

    `https://<HOSTNAME>/<TENANT_CONTEXT>/fhir/r4/Practitioner`
