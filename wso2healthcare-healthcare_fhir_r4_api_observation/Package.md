...
| Documentation        | [https://www.hl7.org/fhir/Observation\.html](https://www.hl7.org/fhir/Observation\.html) |
...
1) Create an API project from this template
    ...
    ```bal new -t wso2healthcare/healthcare.fhir.r4.api.observation ObservationAPI```
...
4) Invoke `<BASE_URL>/fhir/r4/Observation`
    1) Invoke from localhost : `http://localhost:9090/fhir/r4/Observation`
...
6) Invoke `<BASE_URL>/fhir/r4/Observation`

    `https://<HOSTNAME>/<TENANT_CONTEXT>/fhir/r4/Observation`
