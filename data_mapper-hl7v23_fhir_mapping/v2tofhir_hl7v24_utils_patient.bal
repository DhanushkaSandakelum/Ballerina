...
public function GetHL7v24_PID_AdministrativeSex(string pid8) returns r4:PatientGender {
    match pid8 {
        "F" => {
            return "male";
        }
...
public function GetHL7v24_PID_PatientName(hl7v24:XPN[] pid5, hl7v24:XPN[] pid9) returns r4:HumanName[] {
...
public function GetHL7v24_PID_Address(string pid12, hl7v24:XAD[] pid11) returns r4:Address[] {
    ...
    foreach hl7v24:XAD item in pid11 {
        address.push({
            ...
            // text:
            line: [item.xad1.toString(), item.xad2],
            city: item.xad3,
            district: item.xad9,
            state: item.xad4,
...
public function GetHL7v24_PID_PhoneNumber(hl7v24:XTN[] pid13, hl7v24:XTN[] pid14) returns r4:ContactPoint[] {
...
public function GetHL7v24_PID_PrimaryLanguage(hl7v24:CE pid15) returns r4:PatientCommunication[] {
...
public function GetHL7v24_PID_MaritalStatus(string pid16) returns r4:Coding[] {
    r4:Coding[] maritialStatues = [{code: pid16}];

    return maritialStatues;
}

// public function GetHL7v24_PID_Religion(string pid17) returns r4:Extension[]{
...
public function GetHL7v24_PID_SSNNumberPatient(string pid19) returns r4:Identifier[] {
...
public function GetHL7v24_PID_BirthPlace(string pid23) returns r4:Extension[] {
...
public function GetHL7v24_PID_MultipleBirthIndicator(string pid24) returns boolean {
    match pid24 {
        "N" => {
            return false;
        }
...
public function GetHL7v24_PID_BirthOrder(float pid25) returns int {
    return <int>pid25;
}
...
public function GetHL7v24_PID_PatientDeathIndicator(string pid30) returns boolean {
    match pid30 {
        "false" => {
            return false;
        }
